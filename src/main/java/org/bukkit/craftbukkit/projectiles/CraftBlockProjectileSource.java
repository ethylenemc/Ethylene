...
public class CraftBlockProjectileSource implements BlockProjectileSource {
    ...
    public <T extends Projectile> T launchProjectile(Class<? extends T> projectile, Vector velocity) {
        ...
        SourceBlock sourceblock = new SourceBlock((ServerLevel) dispenserBlock.getLevel(), dispenserBlock.getBlockPos(), dispenserBlock.getBlockState(), dispenserBlock);
        // Copied from DispenseBehaviorProjectile
        IPosition iposition = BlockDispenser.getDispensePosition(sourceblock);
        Direction enumdirection = (Direction) sourceblock.state().getValue(BlockDispenser.FACING);
